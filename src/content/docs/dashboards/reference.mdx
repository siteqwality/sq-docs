...
Renders as a big number, the sum of 5xx counts in the time window.
...
- [Dashboards overview](/dashboards/overview/) for the concept.
- [Metrics](/observability/metrics/overview/), [Logs](/observability/logs/overview/), and [Traces](/observability/traces/overview/) for the data sources.
