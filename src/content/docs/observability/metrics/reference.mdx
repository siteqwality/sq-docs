...
```
POST https://metrics.siteqwality.com/v1/ingest
...
- [Metrics overview](/observability/metrics/overview/) — types, conventions.
- [Quickstart](/observability/metrics/quickstart/) — first-metric walkthrough.
