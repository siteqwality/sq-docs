...
class SqHandler(logging.Handler):
    def emit(self, record):
        requests.post(
            "https://logs.siteqwality.com/ingest",
...
**Ship via your existing log pipeline** (Vector, Fluent Bit, Filebeat). Point it at `https://logs.siteqwality.com/ingest` with the API key in the Authorization header.
