...
2. Set the **friendly name**. This is the public page title, so use your product name, e.g. `Acme Cloud`.
...
2. **Upload a logo** in PNG or SVG, up to 2MB. SiteQwality stores it on S3 and serves via CDN.
