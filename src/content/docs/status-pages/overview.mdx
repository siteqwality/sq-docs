---
title: Status pages
description: Branded, custom-domain public status pages with components, scheduled maintenance, and email subscribers.
...
<Aside type="caution">
Visitors subscribe with email and confirm the address. We send email on incident create/update and on status-page maintenance. SMS, RSS, and webhook subscribers are not available.
</Aside>
