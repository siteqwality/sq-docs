...
A geographic location SiteQwality runs checks from. Default is `us-east-1`. Multi-region requires a paid plan; see the [HTTP checks reference](/uptime-monitoring/http-checks/reference/) for the full list.
