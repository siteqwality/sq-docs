...
<Aside type="tip">
You can delete an active override (one currently in effect). The on-call lookup re-evaluates immediately — the next page will route per the underlying layers.
</Aside>
