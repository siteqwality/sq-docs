...
For ping-style "is the box up" checks where there's no HTTP server, use a [DNS check](../../dns-checks/overview/) on the hostname or a [cron heartbeat](../../cron-checks/overview/) the box pings.
...
- [**DNS check**](../../dns-checks/overview/): tracks the registrable domain's resolver answers.
