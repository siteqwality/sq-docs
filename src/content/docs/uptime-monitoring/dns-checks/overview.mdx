...
<Aside type="caution">
The DNS check today is intentionally simple — "does this domain resolve to *something*?" — not "does it resolve to *exactly this*?" If you need stronger record-level guarantees, run a custom HTTP check that triggers a script you control.
</Aside>
